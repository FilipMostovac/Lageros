...
namespace Lageros.Controllers
{
    ...
    public class LaptopsController : Controller
    {
        ...
        public LaptopsController(LagerosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,INV,Model,RAM,CPU,HDD,WINDOWS")] Laptop laptop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,INV,Model,RAM,CPU,HDD,WINDOWS,Izdano")] Laptop laptop)
        {
            if (id != laptop.Id)
            {
                return NotFound();
