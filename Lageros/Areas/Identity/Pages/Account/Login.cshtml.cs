...
namespace Lageros.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<LagerosUser> signInManager, 
        ...
        {
            [Required(ErrorMessage = "Mail je obavezan!")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Krivi email ili lozinka!");
                    return Page();
                }
            }
